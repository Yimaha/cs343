// Pseudo Random-Number Generator : generate repeatable sequence of values that appear random.
//
// Interface :
...
class PRNG {
  ...
  public:
	...
	unsigned int get_seed() const { return seed; }		// get seed
	PRNG( unsigned int seed = 362436069 ) { set_seed( seed ); } // set seed
